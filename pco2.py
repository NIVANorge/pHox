...
class PuckManager(object):
    ...
    def send_data(self, args):
        ...
        dataString = "%.1f,%.4f,%.1f,9999.9999,8888.8888,%.2f,%.2f,%.2f\r" % (
            self.LAST_CO2,
            self.LAST_pH,
            self.LAST_TA,
            self.LAST_PAR[0],
    ...
    def enter_instrument_mode(self, args):
        ...
        self.timerHostPoll.start(
            30000
        )  # poll self.host for instrument specific commands, 1000ms seems to work with timing
