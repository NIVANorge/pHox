...
class Cbon(object):
    def __init__(self):
        ...
        self.BOTTLE='0_5_3_1111'# no pumping
        #self.BOTTLE='30_5_3_1111'## to pump 30sec before sample
...
class inputDialog(QtGui.QDialog):
    def __init__(self, parent=None, title='user input', parString='0_5_3_1111'):
...
class Panel(QtGui.QWidget):
    def __init__(self):
        ...
        self.folderPath ='/home/pi/pHox_data/'
    ...
    def init_ui(self):
        ...
        self.chkBoxNames = ['Spectrophotometer','Take dark','LEDs','Inlet valve','Stirrer','Dye pump','Deploy','Single','Water pump']
 ...
 #________________________________________________________________________________________________________               
    ...
    def on_combo_clicked(self, text):
        ...
        if choice == 5:
            dialog = inputDialog(parent= self, title='BOTTLE setup', parString=self.instrument.UNDERWAY)
            dialog.exec_()
            try:
