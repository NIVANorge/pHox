...
3. create the file `box_id.txt` in your home directory `~/` with a pHox number, `pHox1` or `pHox6` for example.
If pHox cannot find this file or the contens is `pHox0`, it loads a `configs/config_template.json`.
