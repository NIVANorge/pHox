...
if [ "$ans" != "Y" ]
then
    f="/tmp/pHox_co3.desktop"
    g="/home/pi/.config/autostart/pHox_co3.desktop"
    ...
    echo 'NAME=pHox_co3'                                           >> $f
    echo "Exec=sudo bash -c 'cd /home/pi/pHox && /usr/bin/python3 /home/pi/pHox/pHox_gui.py --co3'" >> $f
